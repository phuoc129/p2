...
urlpatterns = [
    ...
    path('stock/report/export-excel/', views.StockReportExportExcelView.as_view(), name='stock_report_export_excel'),
    path('stock/report/export-pdf/', views.StockReportExportPdfView.as_view(), name='stock_report_export_pdf'),
]